...
declare class ProductService {
    constructor();
    findAll: () => Promise<(import("mongoose").Document<unknown, any, import("../model/product").IProduct> & import("../model/product").IProduct & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    createProduct: (product: any) => Promise<void>;
    deleteProduct: (idProduct: any) => Promise<void>;
    findProduct: (id: any) => Promise<import("mongoose").Document<unknown, any, import("../model/product").IProduct> & import("../model/product").IProduct & {
        _id: import("mongoose").Types.ObjectId;
    }>;
